...
namespace UnitTests.AccessorTests
{
    ...
    public class GetOrderWithOrderIdAccessorTests
    {
        ...
        public void ValidGetOrderWithOrderId()
        {
            ...
            OrderDataModel expectedOrder = new OrderDataModel(1, "4829170638572946", shipDate, deliveryDate, 1, shippedFrom, shippedTo);
    ...
    public class GetOrderWithPackageIdAccessorTests
    {
        ...
        public void ValidGetOrderWithPackageId()
        {
            ...
            OrderDataModel expectedOrder = new OrderDataModel(2, "7294061538206194", shipDate, deliveryDate, 2, shippedFrom, shippedTo);
